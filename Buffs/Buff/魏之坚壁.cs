...
{
    public 魏之坚壁(int? remainingTurns = 2, int strength = 1) : base("魏之坚壁", "持有护盾时减伤提升（状态强�?2�?，最终减伤提升（状态强�?2�?；受到伤害时若持有护盾，则受到的最终伤害值降低，降低值为自身生命上限的（状态强�?3�?", remainingTurns, Math.Clamp(strength, 0, 5), isFactionBuff: false, isBuff: true)
    {
