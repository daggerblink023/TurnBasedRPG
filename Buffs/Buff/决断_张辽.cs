...
{
    public 决断_张辽(int? remainingTurns = null, int strength = 1) : base("决断-张辽", "[回合开始时]每拥有1状态强度，会使得张辽在本回合内临时获得15%暴击率，随后为张辽添加（10+防御等级/2）点护盾", remainingTurns, Math.Max(strength, 1), false, true)
    {
